defmodule GingerTeaWeb.UserAuth do
  import Plug.Conn
  ...
  def log_in_user(conn, user, params \\ %{}) do
    ...
    |> json(notify(:ok, user.email))

    # |> json(notify(:ok, "Welcome to the Thunderdome!"))
  end
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      GingerTeaWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  defp signed_in_path(_conn), do: "/api/"
end
