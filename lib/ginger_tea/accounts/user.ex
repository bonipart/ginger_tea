defmodule GingerTea.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, GingerTea.Repo)
  ...
  """
  def valid_password?(%GingerTea.Accounts.User{hashed_password: hashed_password}, password)
