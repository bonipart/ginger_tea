defmodule GingerTeaWeb.UserAuthTest do
  use GingerTeaWeb.ConnCase, async: true

  alias GingerTea.Accounts
  alias GingerTeaWeb.UserAuth
  import GingerTea.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, GingerTeaWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      GingerTeaWeb.Endpoint.subscribe(live_socket_id)
